...
public class Meal {
    ...
    public void setIsFavouriteMeal(boolean state) {
        isFavouriteMeal = state;
    }


    public boolean getIsFavouriteMeal() {
        return isFavouriteMeal;
    }

    public void setPlannedMealDate(String date) {
